...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Make custom-set-variables & custom-set-faces separated to another file in
  ;; order for it not to mess up the =init.el= which is under version control
  (setq custom-file
        (concat
         (file-name-directory dotspacemacs-filepath) "customize.el"))
